...
public class KeepViewHolder extends ViewHolder {

    private static final String TAG = KeepViewHolder.class.getSimpleName();
     ...
     * @param listener
     */
    public void bind(final Context context, final Status model,
...
//                    .setStartDelay(100 * position)
    ...
    public void showPopupMenu(View view, final Status model) {
